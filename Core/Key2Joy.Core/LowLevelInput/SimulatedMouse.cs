...
{
    private static MOUSEEVENTF TranslateButton(Mouse.Buttons buttons, bool keyUp = false) => buttons switch
    {
    ...
    public static void PressButton(Mouse.Buttons buttons) => Send(TranslateButton(buttons));

    public static void ReleaseButton(Mouse.Buttons buttons) => Send(TranslateButton(buttons, true));
