...
public class AnimationFromImagesAction : CoreAction
{
    ...
    private static bool JoinImageSequence(string output, double frameRate = 30, params string[] images) => throw new NotImplementedException("This feature has been disabled as we move to a plugin");//return FFMpeg.JoinImageSequence(output, frameRate, images);
